...
use crate::ocpp16::dto::smart_charge_profile::{CreateProfile, ProfileListQuery, ProfileResponse};
use crate::ocpp16::entity::smart_charge_profile::{ActiveModel, Column, Entity, Model};
