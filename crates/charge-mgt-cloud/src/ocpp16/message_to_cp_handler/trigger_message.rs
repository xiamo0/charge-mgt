...
use ocpp_1_6::{ACTION_TRIGGER_MESSAGE_CONFIRMATION, CALL, CALLERROR, CALLRESULT};
...
impl Handler<TriggerMessageConfirmation> for TriggerMessageRequest {
    ...
    async fn handle_detail(
        ...
        let http_sender = state.http_sender().map_err(|e| AppError::OCPP_1_6_ERROR {
            action: ACTION_TRIGGER_MESSAGE_CONFIRMATION.into(),
    ...
    async fn handle_detail(
        ...
        dispatch_mq_call(state, msg, ACTION_TRIGGER_MESSAGE_CONFIRMATION).await
    }
}
