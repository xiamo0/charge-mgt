...
use ocpp_1_6::ACTION_CLEAR_CHARGING_PROFILE_CONFIRMATION;
...
impl Handler<ClearChargingProfileConfirmation> for ClearChargingProfileRequest {
    ...
    async fn handle_detail_http(
        ...
        dispatch_http_call(state, msg, ACTION_CLEAR_CHARGING_PROFILE_CONFIRMATION).await
    }
    ...
    async fn handle_detail_mq(
        ...
        dispatch_mq_call(state, msg, ACTION_CLEAR_CHARGING_PROFILE_CONFIRMATION).await
    }
}
