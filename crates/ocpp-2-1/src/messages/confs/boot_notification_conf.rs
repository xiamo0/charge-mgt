//! BootNotification Confirmation (Block B)
...
impl BootNotificationConfirmation {
    pub fn new(status: RegistrationStatusEnumType, current_time: impl Into<String>, interval: i32) -> Self {
        Self { status, current_time: current_time.into(), interval, status_info: None }
    }
