//! OCPP 2.0.1 Message Envelope Types
//! 消息封装类型，定义 Call/CallResult/CallError 的序列化和反序列化

use serde::{Deserialize, Serialize};

/// OCPP 2.0.1 Call 消息 (请求)
...
/// OCPP 2.0.1 错误代码枚举 (OCPP 2.0.1 使用 FormatViolationError 而非 1.6 的 FormationViolation)
pub mod error_codes {
